...
import com.example.biblioverso.Views.ReservasActivity

class ReservaAdapter(private val reservas: List<ReservaAdap>, private val activity: ReservasActivity) : RecyclerView.Adapter<ReservaAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        return ViewHolder(layoutInflater.inflate(R.layout.item_reserva, parent, false), activity)
    }
    ...
    class ViewHolder(itemView: View, private val activity: ReservasActivity) : RecyclerView.ViewHolder(itemView) {
        ...
        fun render(reserva: ReservaAdap) {
            ...
            if (reserva.reserva.estado == "Entregado") {
                ...
                btnCancelar.setOnClickListener {
                    activity.cancelar(reserva.reserva.idReserva, reserva.reserva.detalle_reserva[0].libro.idLibro)
                }
            }
